OC.L10N.register(
    ...
    "If you want to allow your Nextcloud users to use OAuth to authenticate to a Zammad instance, create an application in your Zammad admin settings and put the application ID (AppId) and secret below." : "如果要允許Nextcloud用戶使用OAuth對Zammad實例進行身份驗證，請在您的Zammad管理員設置中創建一個應用程序，並將應用程序ID（AppId）和密碼放在下面。",
