OC.L10N.register(
    ...
    "_You have %n open ticket in Zammad._::_You have %n open tickets in Zammad._" : ["Máte %n otvorený ticket v Zammade.","Máte %n otvorené tickety v Zammade.","Máte %n otvorených ticketov v Zammade.","Máte %n otvorených ticketov v Zammade."],
    "Zammad tickets" : "Tikety v Zammade",
    "closed %1$s" : "zatvorených %1$s",
    "updated %1$s" : "upravených %1$s",
    ...
    "Subscription ends: {date}" : "Predplatné sa končí: {date}",
    "Comments" : "Komentáre",
    "internal" : "interné",
