OC.L10N.register(
    ...
    "Zammad notifications" : "Notifications Zammad",
    "_You have %n open ticket in Zammad._::_You have %n open tickets in Zammad._" : ["Vous avez %n ticket ouvert dans Zammad.","Vous avez %n tickets ouverts dans Zammad.","Vous avez %n tickets ouverts dans Zammad."],
    "Zammad tickets" : "Tickets Zammad",
    "closed %1$s" : "%1$s fermé",
    "updated %1$s" : "%1$s mis à jour",
    ...
    "Zammad integration provides a dashboard widget displaying your important notifications,\n\ta search provider for tickets and notifications for new open tickets." : "L'intégration Zammad fournit un widget de tableau de bord affichant vos notifications importantes,\n\tun moteur de recherche de tickets et de notifications pour les nouveaux tickets ouverts.",
    ...
    "Zammad address" : "Adresse de Zammad",
    "Application ID" : "ID d'Application",
    "ID of your application" : "ID de votre application",
    "Application secret" : "Secret d'application",
    "Client secret of your application" : "Secret client de votre application",
    "Enable Zammad link previews" : "Activer les aperçus de liens Zammad",
    "Zammad admin options saved" : "Options d'administration Zammad enregistrées",
    ...
    "Connect to Zammad" : "Se connecter à Zammad",
    "Connected as {user}" : "Connecté en tant que {user}",
    "Disconnect from Zammad" : "Se déconnecter de Zammad",
    ...
    "Failed to save Zammad options" : "Échec de l'enregistrement des options de Zammad",
    "Failed to save Zammad OAuth state" : "Échec de l'enregistrement de l'état OAuth pour Zammad",
    ...
    "Zammad API error" : "Erreur API Zammad",
    "Unknown error" : "Erreur inconnue",
    "Zammad connected accounts settings" : "Paramètres de comptes connectés pour Zammad",
    ...
    "_You have %s open ticket in Zammad._::_You have %s open tickets in Zammad._" : ["Vous avez %s ticket ouvert dans Zammad.","Vous avez %s tickets ouverts dans Zammad.","Vous avez %s tickets ouverts dans Zammad."]
},
